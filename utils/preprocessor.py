...
def rotate_orientation(volume_data, volume_label, orientation=ORIENTATION['coronal']):
    ...
    elif orientation == 'ibsr':
        return volume_data.transpose((2, 0, 1)), volume_label.transpose((1, 0, 2))
    elif orientation == 'ibsr2':
        return volume_data.transpose((2, 1, 0)), volume_label.transpose((1, 2, 0))
    else:
